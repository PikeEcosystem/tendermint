...
const (
	...
	//  calculates this value. Add/remove tendermint-specific field sizes to/from this heuristically determined constant.
...
// Header defines the structure of an tendermint block header.
...
func (vp Entropy) ValidateBasic() error {
	// Add checking for tendermint fields
	if vp.Round < 0 {
		return errors.New("negative Round")
	}
