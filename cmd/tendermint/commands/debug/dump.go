...
var dumpCmd = &cobra.Command{
	...
	Short: "Continuously poll an tendermint process and dump debugging data into a single location",
	Long: `Continuously poll an tendermint process and dump debugging data into a single
