...
var killCmd = &cobra.Command{
	...
	Short: "Kill an tendermint process while aggregating and packaging debugging data",
	Long: `Kill an tendermint process while also aggregating tendermint process data
