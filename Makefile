...
INCLUDE = -I=${GOPATH}/src/github.com/PikeEcosystem/tendermint -I=${GOPATH}/src -I=${GOPATH}/src/github.com/gogo/protobuf/protobuf
...
LD_FLAGS = -X github.com/PikeEcosystem/tendermint/version.OCCoreSemVer=$(VERSION)
BUILD_FLAGS = -mod=readonly -ldflags "$(LD_FLAGS)"
HTTPS_GIT := https://github.com/PikeEcosystem/tendermint.git
...
draw_deps:
	...
	@goviz -i github.com/PikeEcosystem/tendermint/cmd/tendermint -d 3 | dot -Tpng -o dependency-graph.png
.PHONY: draw_deps
...
format:
	...
	find . -name '*.go' -type f -not -path "*.git*"  -not -name '*.pb.go' -not -name '*pb_test.go' | xargs goimports -w -local github.com/PikeEcosystem/tendermint
.PHONY: format
...
DOCKER_HOME = /go/src/github.com/PikeEcosystem/tendermint
