...
import (
	...
	auto "github.com/PikeEcosystem/tendermint/libs/autofile"
	"github.com/PikeEcosystem/tendermint/libs/clist"
	"github.com/PikeEcosystem/tendermint/libs/log"
	tmmath "github.com/PikeEcosystem/tendermint/libs/math"
...
type requestCheckTxAsync struct {
	...
	checkTxCb func(*tmabci.Response)
}
...
// Safe for concurrent use by multiple goroutines.
func (mem *CListMempool) CheckTxSync(tx types.Tx, txInfo TxInfo) (res *tmabci.Response, err error) {
	mem.updateMtx.RLock()
...
func (mem *CListMempool) checkTxAsync(tx types.Tx, txInfo TxInfo, prepareCb func(error),
	...
	mem.proxyAppConn.CheckTxAsync(abci.RequestCheckTx{Tx: tx}, func(res *tmabci.Response) {
		mem.reqResCb(tx, txInfo.SenderID, txInfo.SenderP2PID, res, func(response *tmabci.Response) {
			if checkTxCb != nil {
				checkTxCb(response)
			}
			mem.updateMtx.RUnlock()
...
// here.
func (mem *CListMempool) globalCb(req *tmabci.Request, res *tmabci.Response) {
...
func (mem *CListMempool) reqResCb(
	...
	peerP2PID p2p.ID,
	res *tmabci.Response,
	externalCb func(*tmabci.Response),
) {
...
func (mem *CListMempool) resCbFirstTime(
	...
	case *tmabci.Response_CheckTx:
		if r.CheckTx.Code == tmabci.CodeTypeOK {
			memTx := &mempoolTx{
				height:    mem.height,
...
func (mem *CListMempool) resCbRecheck(req *tmabci.Request, res *tmabci.Response) {
	switch r := res.Value.(type) {
	case *tmabci.Response_CheckTx:
...
func (mem *CListMempool) Update(
	...
	for i, tx := range block.Txs {
		if deliverTxResponses[i].Code == tmabci.CodeTypeOK {
	...
	if mem.config.Recheck {
		...
		_, err = mem.proxyAppConn.BeginRecheckTxSync(tmabci.RequestBeginRecheckTx{
		...
		mem.recheckTxs()
		_, err = mem.proxyAppConn.EndRecheckTxSync(tmabci.RequestEndRecheckTx{Height: block.Height})
		if err != nil {
...
func (mem *CListMempool) recheckTxs() {
	...
	for e := mem.txs.Front(); e != nil; e = e.Next() {
		...
		mem.proxyAppConn.CheckTxAsync(req, func(res *tmabci.Response) {
			wg.Done()
		})
	}

	mem.proxyAppConn.FlushAsync(func(res *tmabci.Response) {})
	wg.Wait()
}
