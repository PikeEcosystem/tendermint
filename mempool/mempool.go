...
type Mempool interface {
	...
	CheckTxSync(tx types.Tx, txInfo TxInfo) (*tmabci.Response, error)
	CheckTxAsync(tx types.Tx, txInfo TxInfo, prepareCb func(error), checkTxCb func(*tmabci.Response))
...
type PostCheckFunc func(types.Tx, *tmabci.ResponseCheckTx) error
...
func PostCheckMaxGas(maxGas int64) PostCheckFunc {
	return func(tx types.Tx, res *tmabci.ResponseCheckTx) error {
		if maxGas == -1 {
			return nil
		}
		if res.GasWanted < 0 {
