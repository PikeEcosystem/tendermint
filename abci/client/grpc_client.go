...
type grpcClient struct {
	...
	client tmabci.ABCIApplicationClient
	...
	globalCb    func(*tmabci.Request, *tmabci.Response) // listens to all callbacks
}
...
func (cli *grpcClient) ApplySnapshotChunkAsync(params types.RequestApplySnapshotChunk, cb ResponseCallback) *ReqRes {
	...
	return cli.finishAsyncCall(req,
		&tmabci.Response{Value: &tmabci.Response_ApplySnapshotChunk{ApplySnapshotChunk: res}}, cb)
}

func (cli *grpcClient) finishAsyncCall(req *tmabci.Request, res *tmabci.Response, cb ResponseCallback) *ReqRes {
...
func (cli *grpcClient) CheckTxSync(params types.RequestCheckTx) (*tmabci.ResponseCheckTx, error) {
...
func (cli *grpcClient) BeginBlockSync(params tmabci.RequestBeginBlock) (*types.ResponseBeginBlock, error) {
...
func (cli *grpcClient) BeginRecheckTxSync(params tmabci.RequestBeginRecheckTx) (*tmabci.ResponseBeginRecheckTx, error) {
	reqres := cli.BeginRecheckTxAsync(params, nil)
	reqres.Wait()
	return reqres.Response.GetBeginRecheckTx(), cli.Error()
}

func (cli *grpcClient) EndRecheckTxSync(params tmabci.RequestEndRecheckTx) (*tmabci.ResponseEndRecheckTx, error) {
