...
func TestProperSyncCalls(t *testing.T) {
	...
	go func() {
		...
		reqres := c.BeginBlockAsync(tmabci.RequestBeginBlock{}, nil)
		_, err := c.FlushSync()
...
func setupClientServer(t *testing.T, app tmabci.Application) (
...
func (slowApp) BeginBlock(req tmabci.RequestBeginBlock) types.ResponseBeginBlock {
