...
// Config defines the top level configuration for an tendermint node
type Config struct {
...
// DefaultConfig returns a default configuration for an tendermint node
...
// BaseConfig defines the base configuration for an tendermint node
...
// DefaultBaseConfig returns a default base configuration for an tendermint node
...
// TestBaseConfig returns a base configuration for testing an tendermint node
...
type MempoolConfig struct {
	...
	// XXX: Unused due to https://github.com/PikeEcosystem/tendermint/issues/5796
