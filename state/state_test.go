...
func testProposerFreq(t *testing.T, caseNum int, valSet *types.ValidatorSet) {
	...
	// tendermint cannot test by bound(margin of error) since `SelectProposer` depends on VRF
	/*
...
func TestProposerPriorityProposerAlternates(t *testing.T) {
	t.Skip("tendermint doesn't select a Proposer based on ProposerPriority")
