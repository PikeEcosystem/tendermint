...
type AppConnQuery interface {
	...
	//	SetOptionSync(key string, value string) (res tmabci.Result)
}
...
func (app *appConnConsensus) BeginBlockSync(req tmabci.RequestBeginBlock) (*types.ResponseBeginBlock, error) {
...
func (app *appConnMempool) CheckTxSync(req types.RequestCheckTx) (*tmabci.ResponseCheckTx, error) {
	return app.appConn.CheckTxSync(req)
}

func (app *appConnMempool) BeginRecheckTxSync(req tmabci.RequestBeginRecheckTx) (*tmabci.ResponseBeginRecheckTx, error) {
	return app.appConn.BeginRecheckTxSync(req)
}

func (app *appConnMempool) EndRecheckTxSync(req tmabci.RequestEndRecheckTx) (*tmabci.ResponseEndRecheckTx, error) {
