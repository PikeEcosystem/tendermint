...
import (
	...
	lproxy "github.com/PikeEcosystem/tendermint/light/proxy"
	lrpc "github.com/PikeEcosystem/tendermint/light/rpc"
	...
	"github.com/PikeEcosystem/tendermint/test/e2e/app"
	e2e "github.com/PikeEcosystem/tendermint/test/e2e/pkg"
)
...
// startNode starts an tendermint node running the application directly. It assumes the tendermint
// configuration is in $OCHOME/config/tendermint.toml.
//
