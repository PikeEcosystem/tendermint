...
import (
	...
	"github.com/PikeEcosystem/tendermint/abci/types/mocks"
...
func TestPruneBlocks(t *testing.T) {
	...
	mockApp.On("BeginRecheckTx", mock.Anything).Return(tmabci.ResponseBeginRecheckTx{Code: tmabci.CodeTypeOK})
	mockApp.On("EndRecheckTx", mock.Anything).Return(tmabci.ResponseEndRecheckTx{Code: tmabci.CodeTypeOK})
