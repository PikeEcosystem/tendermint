...
func (emptyMempool) CheckTxSync(_ types.Tx, _ mempl.TxInfo) (*tmabci.Response, error) {
	return nil, nil
}
func (emptyMempool) CheckTxAsync(_ types.Tx, _ mempl.TxInfo, _ func(error), _ func(*tmabci.Response)) {
}
