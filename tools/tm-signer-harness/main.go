...
import (
	...
	"github.com/PikeEcosystem/tendermint/tools/tm-signer-harness/internal"
...
Use "tm-signer-harness help <command>" for more information about that command.`)
	...
	runCmd.StringVar(&flagOCHome, "ochome", defaultOCHome, "Path to the tendermint home directory")
	runCmd.Usage = func() {
...
Flags:`)
	...
	extractKeyCmd.StringVar(&flagOCHome, "ochome", defaultOCHome, "Path to the tendermint home directory")
