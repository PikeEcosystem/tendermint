...
import (
	...
	bcv0 "github.com/PikeEcosystem/tendermint/blockchain/v0"
	bcv1 "github.com/PikeEcosystem/tendermint/blockchain/v1"
	bcv2 "github.com/PikeEcosystem/tendermint/blockchain/v2"
	cfg "github.com/PikeEcosystem/tendermint/config"
	cs "github.com/PikeEcosystem/tendermint/consensus"
	"github.com/PikeEcosystem/tendermint/crypto"
	"github.com/PikeEcosystem/tendermint/evidence"
	tmjson "github.com/PikeEcosystem/tendermint/libs/json"
	"github.com/PikeEcosystem/tendermint/libs/log"
	tmpubsub "github.com/PikeEcosystem/tendermint/libs/pubsub"
	...
	"github.com/PikeEcosystem/tendermint/p2p/pex"
	"github.com/PikeEcosystem/tendermint/privval"
	"github.com/PikeEcosystem/tendermint/proxy"
	rpccore "github.com/PikeEcosystem/tendermint/rpc/core"
	grpccore "github.com/PikeEcosystem/tendermint/rpc/grpc"
	rpcserver "github.com/PikeEcosystem/tendermint/rpc/jsonrpc/server"
	sm "github.com/PikeEcosystem/tendermint/state"
	"github.com/PikeEcosystem/tendermint/state/indexer"
	blockidxkv "github.com/PikeEcosystem/tendermint/state/indexer/block/kv"
	blockidxnull "github.com/PikeEcosystem/tendermint/state/indexer/block/null"
	"github.com/PikeEcosystem/tendermint/state/indexer/sink/psql"
	"github.com/PikeEcosystem/tendermint/state/txindex"
	"github.com/PikeEcosystem/tendermint/state/txindex/kv"
	"github.com/PikeEcosystem/tendermint/state/txindex/null"
	"github.com/PikeEcosystem/tendermint/statesync"
	"github.com/PikeEcosystem/tendermint/store"
...
// DefaultNewNode returns an tendermint node with default settings for the
...
// NewtendermintNode returns an tendermint node for more safe production environments that don't automatically generate
// critical files. This function doesn't reference local key pair in configurations using KMS.
func NewtendermintNode(config *cfg.Config, logger log.Logger) (*Node, error) {
